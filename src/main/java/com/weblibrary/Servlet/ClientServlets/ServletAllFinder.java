...
public class ServletAllFinder extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (((!"".equals(genre1)) && (!genre1.equals(null)))) list.add(new Genre(genre1));
        if (((!"".equals(genre2)) && (!genre1.equals(null)))) list.add(new Genre(genre2));
        if (((!"".equals(genre3)) && (!genre1.equals(null)))) list.add(new Genre(genre3));
        if (((!"".equals(genre4)) && (!genre1.equals(null)))) list.add(new Genre(genre4));
        if (((!"".equals(genre5)) && (!genre1.equals(null)))) list.add(new Genre(genre5));
        String reference="";
        Book book = new Book(titleOfArticle,titleOfJournal, author, year, reference, list);
        HashSet<Book> books = bookDAO.findAll(book);
